...
let basicSolution = window.hljs.highlight('python', 
"def formatPolynomial(a, b, c):\n" +
'  print (str(a) + "x^2" + " + " + str(b) + "x" + " + " + str(c))'
).value

let advancedSolution = window.hljs.highlight('python', 
'def getSign(number):\n' +
'  if number > 0:\n' +
'    return "-"\n' +
'  return "+"\n\n' +
...
'\n' +
'def formatPolynomial(a, b, c):\n' +
'  a_num = getCoefficient(a)\n' +
'  b_sign = getSign(b)\n' +
'  b_num = getCoefficient(abs(b))\n' +
'  c_sign = getSign(c)\n' +
'  c_num = str(abs(c))\n\n' +
'  print("%sx^2 %s %sx %s %s" % (a_num, b_sign, b_num, c_sign, c_num))').value
...
const About = () => (
    ...
    <div className="content">
      ...
      <pre style={{whiteSpace: "pre"}}><code class="python" dangerouslySetInnerHTML={{__html: basicSolution}}/></pre>
    ...
    <div className="content">
      ...
      <div className="columns">
        <div className="column">
          <pre style={{whiteSpace: "pre"}}><code class="python" dangerouslySetInnerHTML={{__html: advancedSolution}}/></pre>
        </div>
