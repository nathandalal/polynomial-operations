    ...
    return (
      <div style={{verticalAlign: "middle"}}>
        ...
        <div style={{margin: "0 auto", padding: 0, verticalAlign: "middle", position: "relative", width: (unitWidth * (3 * Math.abs(m2) + Math.abs(b2)))}}>
          {m1 ? <div style={{verticalAlign: "middle", position: "absolute", margin: "0 auto", left: -25, top: (unitWidth * 3 * Math.abs(m1) / 2) - 10}}>{m1}x</div> : ""}
        ...
        <div style={{margin: "0 auto", padding: 0, verticalAlign: "middle", position: "relative", width: (unitWidth * (3 * Math.abs(m2) + Math.abs(b2)))}}>
          {b1 && m1 ? <div style={{position: "absolute", margin: "0 auto", left: -25, top: -10, verticalAlign: "middle"}}>+</div> : ""}
          {b1 ? <div style={{position: "absolute", margin: "0 auto", left: -25, top: (unitWidth * Math.abs(b1) / 2) - 10, verticalAlign: "middle"}}>{b1}</div> : ""}
