...
import Model          from './Add/Model.jsx'
import Equation       from './Add/Equation.jsx'
...
export default class Add extends React.Component {
  ...
  getInitialState() {
    ...
    variables.subtractionMode = false
    return variables
  }
      ...
      <div className="content container has-text-centered">
        <div className="columns is-multiline">
          <div className="column is-3-desktop is-6-tablet">
            <Equation title={"First Equation"} a={a1} b={b1} c={c1} />
          ...
          <div className="column is-3-desktop is-6-tablet">
            <Equation title={"Second Equation"} a={a2} b={b2} c={c2} subtracted={subtractionMode} />
          ...
          <div className="column is-3-desktop is-6-tablet">
            <Equation title={"Answer Equation"} 
              a={a1 + a2}
              b={b1 + b2}
              c={c1 + c2} />
          </div>
        ...
        <button 
          className={`button is-medium is-${subtractionMode ? "primary" : "danger"}`}
          onClick={(() => this.setState({subtractionMode: !(subtractionMode)})).bind(this)}>
          Switch to {subtractionMode ? "Addition" : " Subtraction"}
        </button>
        <hr/>
        <Model error={error} a1={a1} b1={b1} c1={c1} a2={a2} b2={b2} c2={c2} />
      </div>
    )
  }
}